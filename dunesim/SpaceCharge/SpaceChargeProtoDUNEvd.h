...
namespace spacecharge {
  class SpaceChargeProtoDUNEvd : public SpaceCharge {
 
    public:
      explicit SpaceChargeProtoDUNEvd(fhicl::ParameterSet const& pset);
      SpaceChargeProtoDUNEvd(SpaceChargeProtoDUNEvd const&) = delete;
      virtual ~SpaceChargeProtoDUNEvd() = default;

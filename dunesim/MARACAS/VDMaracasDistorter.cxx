...
namespace maracas {
  ...
  //--------------------------------------------------------------------
  VDMaracasDistorter::VDMaracasDistorter(fhicl::ParameterSet const& pset)
  {
  ...
  //--------------------------------------------------------------------
  geo::Point_t VDMaracasDistorter::apply(geo::Point_t const& point, bool const forward) const
  {
  ...
  //--------------------------------------------------------------------
  geo::Point_t VDMaracasDistorter::Distort(geo::Point_t const& point) const
  {
    return apply(point, true);
  }

  //--------------------------------------------------------------------
  geo::Point_t VDMaracasDistorter::Correct(geo::Point_t const& point) const
  {

...
void load_services(int fftsize =0) {
  ...
  scfg = "Name: \"dune35t4apa_v5\" GDML: \"dune35t4apa_v5.gdml\" ROOT: \"dune35t4apa_v5.gdml\" SortingParameters: { DetectorVersion: \"dune35t4apa_v5\" } SurfaceY: 0.0e2 DisableWiresInG4: true";
  cout << myname << "Configuration: " << scfg << endl;
  assert( ash.addService("Geometry", scfg) == 0 );

  cout << myname << line << endl;
  cout << myname << "Add ExptGeoHelperInterface service." << endl;

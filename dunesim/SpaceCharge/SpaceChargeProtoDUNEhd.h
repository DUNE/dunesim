////////////////////////////////////////////////////////////////////////
// \file SpaceChargeProtoDUNEhd.h
//
// \brief header of class for storing/accessing space charge distortions for ProtoDUNEhd
//
...
namespace spacecharge {
  class SpaceChargeProtoDUNEhd : public SpaceCharge {
 
    public:
      explicit SpaceChargeProtoDUNEhd(fhicl::ParameterSet const& pset);
      SpaceChargeProtoDUNEhd(SpaceChargeProtoDUNEhd const&) = delete;
      virtual ~SpaceChargeProtoDUNEhd() = default;
